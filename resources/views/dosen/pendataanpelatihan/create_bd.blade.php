<form action="{{ url('/pendataan/pelatihan/storebd') }}" method="post" id="form-tambah-bd">
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="modal-footer">
                            <button type="button" onclick="modalAction('{{ url('/pendataan/pelatihan/create_new') }}')" class="btn btn-warning">Kembali</button>
