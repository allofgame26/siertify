<form action="{{ url('/pendataan/pelatihan/updatemk') }}" method="post" id="form-edit-mk">
    @csrf
    @method('PUT')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-green">
                    <p>Pilih mata kuliah yang relevan dengan riwayat pelatihan Anda</p>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="checkbox-container">
                            ...
                            @else
                                @foreach ($mk as $mkItem)
                                    <div id="chk{{ $mkItem->id_mk }}" class="checkbox-item"
                                        value="{{ $mkItem->nama_mk }}">
                                        <label>
                                            <input type="checkbox" name="id_mk[]" value="{{ $mkItem->id_mk }}"
                                                @if (in_array($mkItem->nama_mk, $mataKuliah)) checked @endif>
                                            {{ $mkItem->nama_mk }}
                                        </label>
                                    </div>
                                @endforeach
                    ...
                    <div class="col-md-12">
                        <div class="modal-footer">
                            <button type="button"
                                onclick="modalAction('{{ url('/pendataan/pelatihan/' . $id_detail . '/edit') }}')"
    ...
    $(document).ready(function() {
        ...
        $("#form-edit-mk").validate({
            ...
            submitHandler: function(form) {
                ...
                let data = $('#form-edit-mk').find(':input').serializeArray();
