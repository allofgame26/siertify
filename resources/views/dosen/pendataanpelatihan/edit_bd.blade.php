<form action="{{ url('/pendataan/pelatihan/updatebd') }}" method="post" id="form-edit-bd">
    @csrf
    @method('PUT')
                ...
                @endif
                    ...
                    <div class="col-md-12">
                        <div class="modal-footer">
                            <button type="button" onclick="modalAction('{{ url('/pendataan/pelatihan/' . $id_detail . '/edit') }}') " class="btn btn-warning">Kembali</button>
