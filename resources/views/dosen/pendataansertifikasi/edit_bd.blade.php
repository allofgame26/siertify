<form action="{{ url('/pendataan/sertifikasi/updatebd') }}" method="post" id="form-edit-bd">
    @csrf
    @method('PUT')
                ...
                @endif
                    ...
                    <div class="col-md-12">
                        <div class="modal-footer">
                            <button type="button" onclick="modalAction('{{ url('/pendataan/sertifikasi/' . $id_detail . '/edit') }}') " class="btn btn-warning">Kembali</button>
