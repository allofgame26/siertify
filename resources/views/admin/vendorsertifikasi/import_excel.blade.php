<form action="{{ url('/vendor/sertifikasi/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_vendor_sertifikasi.xlsx') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i>  Download</a>
                    <small id="error-kategori_id" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Pilih File</label>
                    <input type="file" name="file_vendor" id="file_vendor" class="formcontrol" required>
                    <small id="error-file_vendor" class="error-text form-text textdanger"></small>
                </div>
            </div>
