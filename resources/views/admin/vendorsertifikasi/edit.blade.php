...
@else
    <form action="{{ url('/vendor/sertifikasi/' . $vendor->id_vendor_sertifikasi . '/update_ajax') }}" method="POST"
        id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $vendor->nama_vendor_sertifikasi }}" type="text" name="nama_vendor_sertifikasi"
                            id="nama_vendor_sertifikasi" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $vendor->notelp_vendor_sertifikasi }}" type="text" name="notelp_vendor_sertifikasi"
                            id="notelp_vendor_sertifikasi" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $vendor->web_vendor_sertifikasi }}" type="text" name="web_vendor_sertifikasi"
                            id="web_vendor_sertifikasi" class="form-control" placeholder="Enter alamat web" required>
