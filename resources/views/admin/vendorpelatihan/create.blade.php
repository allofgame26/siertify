<form action="{{ url('/vendor/pelatihan/ajax') }}" method="post" id="form-tambah-vendor">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="nama_vendor_pelatihan" id="nama_vendor_pelatihan"
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <input value="" type="text" name="alamat_vendor_pelatihan"
                                id="alamat_vendor_pelatihan" class="form-control" placeholder="Enter alamat" required>
                            <small id="error-alamat_vendor_pelatihan" class="error-text form-text text-danger"></small>

                        </div>
                        <div class="col-4">
                            <label>Kota Vendor</label>
                            <input value="" type="text" name="kota_vendor_pelatihan" id="kota_vendor_pelatihan"
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="notelp_vendor_pelatihan" id="notelp_vendor_pelatihan"
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="web_vendor_pelatihan" id="web_vendor_pelatihan"
