        ...
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $detailpelatihan->tanggal_mulai }}"  type="date" name="tanggal_mulai" id="tanggal_mulai" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Tanggal Selesai</label>
                                    <input value="{{ $detailpelatihan->periode->tanggal_selesai }}" type="date" name="tanggal_selesai" id="tanggal_selesai" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>lokasi</label>
                        <input value="{{ $detailpelatihan->lokasi }}" type="text" name="lokasi" id="lokasi" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Quota Peserta</label>
                        <input value="{{ $detailpelatihan->quota_peserta }}" type="text" name="quota_peserta" id="quota_peserta" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Biaya</label>
                        <input value="{{ $detailpelatihan->biaya }}" type="number" name="biaya" id="biaya" class="form-control" readonly>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            tableDetail = $('#table-pelatihan').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "{{ url('/detailpelatihan/' . $detailpelatihan->id_detail_pelatihan . '/showpeserta') }}",
                    "dataType": "json",
                    "type": "POST",
                    "headers": {
