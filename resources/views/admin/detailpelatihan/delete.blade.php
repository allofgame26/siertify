...
@else
    <form action="{{ url('/detailpelatihan/' . $detailpelatihan->id_detail_pelatihan . '/delete') }}" method="POST" id="form-delete-pelatihan">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $detailpelatihan->pelatihan->id_pelatihan}}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama pelatihan :</th>
                            <td class="col-9">{{ $pelatihan->firstWhere('id_pelatihan', $detailpelatihan->id_pelatihan)?->nama_pelatihan ?? 'Tidak Diketahui' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col-9">{{ $detailpelatihan->periode->nama_periode }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Lokasi</th>
                            <td class="col-9">{{ $detailpelatihan->lokasi }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Biaya</th>
                            <td class="col-9">{{ $detailpelatihan->biaya }}</td>
                        </tr>
                    </table>
                </div>
