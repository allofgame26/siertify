            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <img id="current-foto_profil" src="{{ asset('gambar/' . $user->foto_profil) }}" class="img-foto_profil mb-2"
                            alt="Foto Profil Saat Ini" style="width: 100px; height: 100px; object-fit: cover;"><br>
                        <input type="file" name="foto_profil" id="foto_profil" value="{{ $user->foto_profil }}" class="form-control"
                            accept="image/*">
        ...
        $(document).ready(function() {
            ...
            $("#foto_profil").change(function() {
                ...
                reader.onload = function(e) {
                    $('#current-foto_profil').attr('src', e.target.result); // Mengganti src gambar profil saat ini
                }
