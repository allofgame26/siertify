    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ url('/detailsertifikasi') }}" class="btn btn-warning">Kembali</a>
            </div>
        </div>
    </div>
@else
    <form action="{{ url('/detailsertifikasi/' . $detailsertifikasi->id_sertifikasi. '/update') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Detail Sertifikasi</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="id_sertifikasi" id="id_sertifikasi" class="form-control" readonly>
                            @foreach ($sertifikasi as $l)
                            <option {{ $l->sertifikasi == $detailsertifikasi->id_sertifikasi ? 'selected' : '' }} 
                            value="{{ $l->id_sertifikasi }}">{{ $l->nama_sertifikasi }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Jumlah Peserta</label>
                        <input value="{{ $detailsertifikasi->quota_peserta }}" type="text" name="quota_peserta" id="quota_peserta"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $detailsertifikasi->biaya }}" type="number" name="biaya" id="biaya"
                            class="form-control" placeholder="Enter biaya pelatihan" required>
                        <small id="error-biaya" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Lokasi Pelatihan</label>
                        <input value="{{ $detailsertifikasi->lokasi }}" type="text" name="lokasi" id="lokasi"
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_periode" id="id_periode" required>
                                    <option value="{{ $detailsertifikasi->periode->nama_periode }}">- Pilih periode -</option>
                                    @foreach ($periode as $l)
                                        <option {{ $l->id_periode == $detailsertifikasi->id_periode ? 'selected' : '' }}
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $detailsertifikasi->tanggal_mulai }}" type="date" name="tanggal_mulai"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $detailsertifikasi->tanggal_selesai }}" type="date" name="tanggal_selesai"
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="padding-left">
                            <button type="button"
                                onclick="modalAction('{{ url('/detailsertifikasi/' . $detailsertifikasi->id_detail_sertifikasi . '/editmk') }}')"
                    ...
                    <div class="row">
                        ...
                        <div class="col-2" style="padding-left">
                            <button type="button"
                                onclick="modalAction('{{ url('/detailsertifikasi/' . $detailsertifikasi->id_detail_sertifikasi . '/editbd') }}')"
                                class="btn btn-success btn-sm">
                                <i class="fas fa-plus-square" style="margin-right: 8px;"></i>Edit
                            </button>
                        </div>
